                                                            ...
                                                            <td align="center" style="padding:0;Margin:0;font-size:0px">
                                                                <a target="_blank" href="${V_DOMAIN_URL}"
                                                                   style="mso-line-height-rule:exactly;text-decoration:underline;color:#EDEDED;font-size:14px"><img
                                                                            src="https://www.novobit.eu/wp-content/uploads/2023/08/novobit_Logo_rgb.png"
                                                                            alt="Logo"
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:Lexend, Arial, sans-serif;line-height:21px;letter-spacing:0;color:#2C2C2C;font-size:14px">
                                                                    <br></p>
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:Lexend, Arial, sans-serif;line-height:21px;letter-spacing:0;color:#2C2C2C;font-size:14px">
                                                                    ${V_SHARED_BY} Shared with you the resume of th
                                                                    candidate ${V_CONDIDATE_FULLNAME}.
                                                                </p>
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:Lexend, Arial, sans-serif;line-height:21px;letter-spacing:0;color:#2C2C2C;font-size:14px">
                                                                    Please take a look on the resume and give a global
                                                                    rate on this.
                                                                </p>
                                                                <p style="Margin:0;mso-line-height-rule:exactly;font-family:Lexend, Arial, sans-serif;line-height:21px;letter-spacing:0;color:#2C2C2C;font-size:14px">
                                                                    <br>
                                                        ...
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0"><!--[if mso]>
                                                                ...
                                                                <![endif]--><!--[if !mso]><!-- --><span
                                                                        ...
                                                                        style="border-style:solid;border-color:#2CB543;background:#FF4A4A;border-width:0px;display:inline-block;border-radius:30px;width:auto;mso-hide:all"><a
                                                                            href="tel:${V_DOMAIN_PHONE}"
                                                                            class="es-button"
                                                                            target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#FFFFFF;font-size:18px;padding:10px 30px 10px 30px;display:inline-block;background:#FF4A4A;border-radius:30px;font-family:Lexend, Arial, sans-serif;font-weight:normal;font-style:normal;line-height:22px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #FF4A4A">${V_DOMAIN_PHONE}</a></span>
                                                                <!--<![endif]--></td>
                                                        </tr>
                                                    </table>
                                                </td>
