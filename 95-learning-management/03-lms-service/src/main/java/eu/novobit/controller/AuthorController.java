...
import eu.novobit.api.AuthorControllerApi;
...
public class AuthorController extends MappedCrudController<Author, AuthorDto, AuthorDto, AuthorService> implements AuthorControllerApi {
